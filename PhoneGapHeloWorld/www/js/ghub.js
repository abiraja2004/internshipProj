        ...
        var xhr = new XMLHttpRequest();
            xhr.onreadystatechange = function() {
                    if (xhr.readyState == XMLHttpRequest.DONE) {
                        ...
                        $scope.myDataSource = xhr.responseText
                        var commitChartDirective = $compile( '<fusioncharts width="600" height="400" type="column2d" datasource="{{myDataSource}}"></fusioncharts>' )( $scope )
